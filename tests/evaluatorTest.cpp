...
TEST(EvaluatorTest, EvaluateExpressionComplex) {
  ...
  std::unordered_map<std::string, bool> inputs1 = {
      {"p", false}, {"q", false}, {"r", false}};
  std::unordered_map<std::string, bool> inputs2 = {
      {"p", true}, {"q", false}, {"r", false}};
  std::unordered_map<std::string, bool> inputs3 = {
      {"p", false}, {"q", true}, {"r", false}};
  std::unordered_map<std::string, bool> inputs4 = {
      {"p", true}, {"q", true}, {"r", false}};
  std::unordered_map<std::string, bool> inputs5 = {
      {"p", false}, {"q", false}, {"r", true}};
  std::unordered_map<std::string, bool> inputs6 = {
      {"p", true}, {"q", false}, {"r", true}};
  std::unordered_map<std::string, bool> inputs7 = {
      {"p", false}, {"q", true}, {"r", true}};
  std::unordered_map<std::string, bool> inputs8 = {
      {"p", true}, {"q", true}, {"r", true}};
